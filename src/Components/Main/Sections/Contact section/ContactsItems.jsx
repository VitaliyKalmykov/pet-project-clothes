...
const socialLinks = [
    { id: 'telegram', href: 'https://t.me/your_username', label: 'Telegram' },
    { id: 'mail', href: 'mailto:your_email@example.com', label: 'Mail' },
    { id: 'skype', href: 'skype:your_skype_id?chat', label: 'Skype' },
    { id: 'linkedin', href: 'https://www.linkedin.com/in/your_profile/', label: 'LinkedIn' }
];
